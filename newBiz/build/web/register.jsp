        ...
        <div class="row centered-form" style="text-align:center;">
         ...
         <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	...
        	<div class="panel panel-default">
			    		...
			    		<form action="RegisterServlet" method="POST" role="form" name="registration">
			    			<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			    						<input type="number" name="userId" class="form-control input-sm" placeholder="Contact No" maxlength="10">
                                                        ...
                                                        <div class="form-group">
			    				<input type="number" name="sponseId" class="form-control input-sm" placeholder="Sponse ID" maxlength="40">
                                                        
			    			        </div>
                                                         
                                                        <div class="form-group">
			    				<input type="number" name="aadhar" class="form-control input-sm" placeholder="Aadhar No" maxlength="40">
			    			        </div>
